    		  ...
    		  <div class="row">
		          ...
		          <div class="jumbotron" id="part_2">
		                ...
		                <div class="jumbotron" id="profile_view">
		                    <img src="<?php echo base_url();?>profile_photo/<?php echo $youp->photo;?>" id="set_photo" width="72" height="72" class="img-#">
		                    <center style="color:black" id="namev"><?php echo ucfirst($row->username);?> <small style="color:rgb(204,214,221);">@<?php echo ucfirst($row->username);?></small></center>
		                    <br>
		                    <br>
		                    <table width="100%" border="0">
		                    	<tr>
		                    		<td style="color:#8899a6;" width="33%"><center>MEW</center></td>
		                    		<td style="color:#8899a6;" width="33%"><center>FOLLOWING</center></td>
		                    		<td style="color:#8899a6;" width="33%"><center>FOLLOWERS</center></td>
		                    	</tr>
		                    	<tr>
		                    		...
		                    		?> 
		                    		<center><a href="" style="text-decoration:none;font-size:19px;"><?php echo count($c_post);?></a></center>
		                    		</td>
					                ...
					                ?>
		                    		<center><a href="" style="text-decoration:none;font-size:19px;"><?php echo count($arr)-1;?></a></center>
		                    		</td>
					                ...
					                ?>
		                    		<center><a href="" style="text-decoration:none;font-size:19px;"><?php echo count($arrx)-1;?></a></center>
		                    		</td>
		                    	</tr>
		                    </table>
		                </div>
		    	...
		    	<center style="color: #66757f;font-size: 18px;font-weight: 300;"><small>QUICK FILTER</small></center>
		    	<br>
				  <button type="button" class="btn btn-default " id="a_p" ><i class="fa fa-newspaper-o" style="float:left;color:black;"></i>PUBLIC MEW</button>
				  <button type="button" class="btn btn-default " id="f_p" ><i class="fa fa-users" style="float:left;color:black;"></i>FOLLOWING</button>
				  <button type="button" class="btn btn-default " id="p_p" ><span class="glyphicon glyphicon-camera" style="float:left;color:black;"></span>PHOTO</button>
				  <button type="button" class="btn btn-default " id="m_p" ><i class="fa fa-soundcloud" style="float:left;color:black;"></i>MUSIC</button>
				  <button type="button" class="btn btn-default " id="v_p" ><i class="fa fa-youtube" style="float:left;color:black;"></i>VIDEO</button>
				</div>
				...
				<div class="jumbotron" id="other_user"> 
					...
					<tr>
						<td rowspan="2" width="25%"><img src="<?php echo base_url();?>profile_photo/<?php echo $g_other->photo;?>" class="img-circle" width="50px" height="50px"></td>
						<td style="color:black"><?php echo ucfirst($g_other->username);?></td>
						<td><span class="glyphicon glyphicon-remove" style="float:right;font-size:8px;"></span></td>
					</tr>
					<tr>
						<td width="33.3%" style="color:rgb(204,214,221);">@<?php echo $g_other->username;?></td>
		         ...
		         <div class="col-md-8">
		            ...
		            <div class="jumbotron" id="post" style="display:#;margin-top:2px;" >
		            	...
		            	<div class="jumbotron" id="post_footer">
		            		...
		            		<button type="submit" class="btn btn-default btn-sm" id="ajax_photo" style="background-color:#8E44AD;color:#fff;border:none;" ><i class="fa fa-bolt"></i> Post</button>

		            	    </form>

		            		<button class="btn btn-default btn-sm" id="np_send" style="background-color:#8E44AD;color:#fff;border:none;">MEW</button>		
                   ...
                   <div class="jumbotron" id="more_ping"><center><a href="">View 1 more mew</a></center></div>
                   <br>
...
<div id="popup3" class="modal-box" style="position:fixed;margin-top:-50px;height:500px;">
  ...
  $all_n = $this->db->get('notification')->result();
						...
						<tr>
							...
							<a href="" style="color:#8E44AD"><b><?php echo ucfirst($from);?></b></a>
						...
						<tr>
							...
							<?php
							  ...
							  <td style="font-size:13px;">commented on <a href=""> you <a href="<?php echo base_url();?>profile/activityView/<?php echo $row->username;?>/<?php echo $active->post_id;?>">mew</a></td>

							  <?php }else if($active->type == 'likes'){?>

							  <td style="font-size:13px;">like <a href=""> you </a> <a href="<?php echo base_url();?>profile/activityView/<?php echo $row->username;?>/<?php echo $active->post_id;?>">mew</a></td>
							  ...
							  <td style="font-size:13px;"> share you <a href="<?php echo base_url();?>profile/activityView/<?php echo $row->username;?>/<?php echo $active->post_id;?>">mew</a></td>

							   <?php }else if($active->type == 'mention'){?>

							  <td style="font-size:13px;"> mention  you in a <a href="<?php echo base_url();?>profile/statusView/<?php echo $row->username;?>/<?php echo $active->post_id;?>">mew</a></td>

							  <?php }else{?>


							  <td style="font-size:13px;"> updated his <a href="<?php echo base_url();?>profile/statusView/<?php echo $row->username;?>/<?php echo $active->post_id;?>">mew</a></td>
...
<div id="popup4" class="modal-box" style="position:fixed;margin-top:-50px;height:500px;">
  ...
  foreach($send_f as $send_pto){} ?>
  	...
  	<tr>
  		...
  		<td><a href="" style="color:#8E44AD;font-weight:bold;"><?php echo ucfirst($sms->user_from);?></a></td>
